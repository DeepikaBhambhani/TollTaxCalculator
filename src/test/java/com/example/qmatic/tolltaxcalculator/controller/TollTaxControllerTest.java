...
@WebMvcTest(value = TollTaxController.class)
class TollTaxControllerTest {

    @MockBean
    private static TollTaxController taxController;
    ...
    public void testController() throws Exception {
        ...
        MockHttpServletRequestBuilder reqBuilder = MockMvcRequestBuilders.post("/tollCalculator/tax")
